...
export function SignupFormDemo() {
    ...
    return (
        <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white  bg-black">
            <h2 className="font-bold text-xl text-neutral-800  text-neutral-200">
                Welcome to Aceternity
            </h2>
            <p className="text-neutral-600 text-sm max-w-sm mt-2  text-neutral-300">
            ...
            <form className="my-8" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col space-y-4">
                    <button
                        ...
                        type="submit"
                    >
                        <IconBrandGithub className="h-4 w-4 text-neutral-800  text-neutral-300" />
                    ...
                    <button
                        ...
                        type="submit"
                    >
                        <IconBrandGoogle className="h-4 w-4 text-neutral-800  text-neutral-300" />
                        <span className="text-neutral-700  text-neutral-300 text-sm">
                            Google
                        </span>
                        <BottomGradient />
